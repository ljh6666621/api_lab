...
> Day2-Day3 实训项目 — 基于 FastAPI 的分层架构 RESTful API 服务，集成商品管理、用户认证、部门管理、LLM 大模型对话及 NL2SQL 自然语言转 SQL 功能。
...
本项目现已扩展至覆盖「数据采集、数据资产、智能问数、即时通讯、数字员工、模型与技能」六大协同模块。所有新增模块均遵循 routers/services/models/schemas/core 分层约束。
